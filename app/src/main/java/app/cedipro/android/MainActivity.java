...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.tsl_item) {
            fragmentManager.beginTransaction().replace(R.id.contenedor, new TSLFragment()).commit();
            getSupportActionBar().setTitle("T.S.L.");
        } else if (id == R.id.rem_item) {
            getSupportActionBar().setTitle("R.E.M.");
            fragmentManager.beginTransaction().replace(R.id.contenedor, new REMFragment()).commit();
        } else if (id == R.id.noticias_item) {
            getSupportActionBar().setTitle("Noticias");
            fragmentManager.beginTransaction().replace(R.id.contenedor, new NoticiasFragment()).commit();
        } else if (id == R.id.compras_item) {
            fragmentManager.beginTransaction().replace(R.id.contenedor, new ComprasFragment()).commit();
            getSupportActionBar().setTitle("Compras");
        } else if (id == R.id.acercade_item) {
